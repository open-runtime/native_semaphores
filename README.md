...
```yaml
dependencies:
  runtime_native_semaphores: ^1.0.5
```
...
| Module | Docs |
|--------|------|
| **Semaphore Core** | [docs](docs/core/) |
| **Unix FFI Bindings** | [docs](docs/unix/) |
| **Windows FFI Bindings** | [docs](docs/windows/) |
| **FFI Bindings** | [docs](docs/ffi/) |
| **Utils** | [docs](docs/utils/) |
| **Package Entry Points** | [docs](docs/top_level/) |
