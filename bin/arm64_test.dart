...
import "package:runtime_native_semaphores/ffi/unix.dart"
    show MODE_T_PERMISSIONS, SemOpenError, SemOpenUnixMacros, arm64_sem_open, errno, sem_close, sem_t, sem_unlink;
...
main() {
  ...
  Pointer<sem_t> sem = arm64_sem_open(name, 512, MODE_T_PERMISSIONS.RECOMMENDED, 1);
