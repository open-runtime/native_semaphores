...
main() {
  ...
  Pointer<sem_t> sem = sem_open(name, UnixSemOpenMacros.O_EXCL, MODE_T_PERMISSIONS.RECOMMENDED, 1);
  Pointer<sem_t> sem_2 = sem_open(name_2, UnixSemOpenMacros.O_EXCL, MODE_T_PERMISSIONS.RECOMMENDED, 1);
  ...
  try {
    (sem_2.address != UnixSemOpenMacros.SEM_FAILED.address) ||
        (throw "${UnixSemOpenError.fromErrno(errno.value).toString()}");
  } catch (e) {
    print(e);
  }
