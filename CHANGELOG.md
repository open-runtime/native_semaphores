...
### Added
- Multi-platform CI testing on all 6 platform legs: Ubuntu x64/arm64, macOS x64/arm64, Windows x64/arm64
- Configured runtime-* org-managed runners for ARM64 platforms (Ubuntu, Windows)

### Changed
- Upgraded runtime_ci_tooling to v0.12.2 for multi-platform CI matrix generation
- CI workflow now uses separate analyze (single runner) and test (matrix) jobs
...
[1.0.7]: https://github.com/open-runtime/native_semaphores/compare/v1.0.6...v1.0.7
