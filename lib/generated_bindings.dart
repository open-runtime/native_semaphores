...
typedef NativeHelloWorldFunction = ffi.Pointer<sem_t> Function(
    ffi.Pointer<ffi.Char>, ffi.Int, ffi.VarArgs<(mode_t, ffi.UnsignedInt)>);
...
class HelloWorld {
  ...
  HelloWorld(ffi.DynamicLibrary dynamicLibrary) : _lookup = dynamicLibrary.lookup;

  /// The symbols are looked up with [lookup].
  HelloWorld.fromLookup(ffi.Pointer<T> Function<T extends ffi.NativeType>(String symbolName) lookup) : _lookup = lookup;
  ...
  late final _openatPtr =
      _lookup<ffi.NativeFunction<ffi.Int Function(ffi.Int, ffi.Pointer<ffi.Char>, ffi.Int)>>('openat');
  ...
  late final _openx_npPtr =
      _lookup<ffi.NativeFunction<ffi.Int Function(ffi.Pointer<ffi.Char>, ffi.Int, filesec_t)>>('openx_np');
  late final _openx_np = _openx_npPtr.asFunction<int Function(ffi.Pointer<ffi.Char>, int, filesec_t)>();
  ...
  late final _open_dprotected_npPtr =
      _lookup<ffi.NativeFunction<ffi.Int Function(ffi.Pointer<ffi.Char>, ffi.Int, ffi.Int, ffi.Int)>>(
          'open_dprotected_np');
  late final _open_dprotected_np =
      _open_dprotected_npPtr.asFunction<int Function(ffi.Pointer<ffi.Char>, int, int, int)>();
  ...
  late final _openat_dprotected_npPtr =
      _lookup<ffi.NativeFunction<ffi.Int Function(ffi.Int, ffi.Pointer<ffi.Char>, ffi.Int, ffi.Int, ffi.Int)>>(
          'openat_dprotected_np');
  late final _openat_dprotected_np =
      _openat_dprotected_npPtr.asFunction<int Function(int, ffi.Pointer<ffi.Char>, int, int, int)>();
  ...
  late final _openat_authenticated_npPtr =
      _lookup<ffi.NativeFunction<ffi.Int Function(ffi.Int, ffi.Pointer<ffi.Char>, ffi.Int, ffi.Int)>>(
          'openat_authenticated_np');
  late final _openat_authenticated_np =
      _openat_authenticated_npPtr.asFunction<int Function(int, ffi.Pointer<ffi.Char>, int, int)>();
  ...
  late final _flock1Ptr = _lookup<ffi.NativeFunction<ffi.Int Function(ffi.Int, ffi.Int)>>('flock');
  ...
  late final _filesec_initPtr = _lookup<ffi.NativeFunction<filesec_t Function()>>('filesec_init');
  ...
  late final _filesec_dupPtr = _lookup<ffi.NativeFunction<filesec_t Function(filesec_t)>>('filesec_dup');
  ...
  late final _filesec_freePtr = _lookup<ffi.NativeFunction<ffi.Void Function(filesec_t)>>('filesec_free');
  ...
  late final _filesec_get_propertyPtr =
      _lookup<ffi.NativeFunction<ffi.Int Function(filesec_t, ffi.Int32, ffi.Pointer<ffi.Void>)>>(
          'filesec_get_property');
  late final _filesec_get_property =
      _filesec_get_propertyPtr.asFunction<int Function(filesec_t, int, ffi.Pointer<ffi.Void>)>();
  ...
  late final _filesec_query_propertyPtr =
      _lookup<ffi.NativeFunction<ffi.Int Function(filesec_t, ffi.Int32, ffi.Pointer<ffi.Int>)>>(
          'filesec_query_property');
  late final _filesec_query_property =
      _filesec_query_propertyPtr.asFunction<int Function(filesec_t, int, ffi.Pointer<ffi.Int>)>();
  ...
  late final _filesec_set_property =
      _filesec_set_propertyPtr.asFunction<int Function(filesec_t, int, ffi.Pointer<ffi.Void>)>();
  ...
  late final _filesec_unset_propertyPtr =
      _lookup<ffi.NativeFunction<ffi.Int Function(filesec_t, ffi.Int32)>>('filesec_unset_property');
  ...
  late final _sem_closePtr = _lookup<ffi.NativeFunction<ffi.Int Function(ffi.Pointer<sem_t>)>>('sem_close');
  late final _sem_close = _sem_closePtr.asFunction<int Function(ffi.Pointer<sem_t>)>();
  ...
  late final _sem_destroyPtr = _lookup<ffi.NativeFunction<ffi.Int Function(ffi.Pointer<sem_t>)>>('sem_destroy');
  late final _sem_destroy = _sem_destroyPtr.asFunction<int Function(ffi.Pointer<sem_t>)>();
  ...
  late final _sem_getvaluePtr =
      _lookup<ffi.NativeFunction<ffi.Int Function(ffi.Pointer<sem_t>, ffi.Pointer<ffi.Int>)>>('sem_getvalue');
  late final _sem_getvalue = _sem_getvaluePtr.asFunction<int Function(ffi.Pointer<sem_t>, ffi.Pointer<ffi.Int>)>();
  ...
  late final _sem_initPtr =
      _lookup<ffi.NativeFunction<ffi.Int Function(ffi.Pointer<sem_t>, ffi.Int, ffi.UnsignedInt)>>('sem_init');
  late final _sem_init = _sem_initPtr.asFunction<int Function(ffi.Pointer<sem_t>, int, int)>();
  ...
  late final _sem_openPtr =
      _lookup<ffi.NativeFunction<ffi.Pointer<sem_t> Function(ffi.Pointer<ffi.Char>, ffi.Int)>>('sem_open');
  late final _sem_open = _sem_openPtr.asFunction<ffi.Pointer<sem_t> Function(ffi.Pointer<ffi.Char>, int)>();
  ...
  late final _sem_postPtr = _lookup<ffi.NativeFunction<ffi.Int Function(ffi.Pointer<sem_t>)>>('sem_post');
  late final _sem_post = _sem_postPtr.asFunction<int Function(ffi.Pointer<sem_t>)>();
  ...
  late final _sem_trywaitPtr = _lookup<ffi.NativeFunction<ffi.Int Function(ffi.Pointer<sem_t>)>>('sem_trywait');
  late final _sem_trywait = _sem_trywaitPtr.asFunction<int Function(ffi.Pointer<sem_t>)>();
  ...
  late final _sem_unlinkPtr = _lookup<ffi.NativeFunction<ffi.Int Function(ffi.Pointer<ffi.Char>)>>('sem_unlink');
  late final _sem_unlink = _sem_unlinkPtr.asFunction<int Function(ffi.Pointer<ffi.Char>)>();
  ...
  late final _sem_waitPtr = _lookup<ffi.NativeFunction<ffi.Int Function(ffi.Pointer<sem_t>)>>('sem_wait');
  late final _sem_wait = _sem_waitPtr.asFunction<int Function(ffi.Pointer<sem_t>)>();
  ...
  ffi.Pointer<sem_t> hello_world(ffi.Pointer<ffi.Char> name, int oflag, int mode, int value) {
    return _hello_world(name, oflag, mode, value);
  }

  late final _hello_worldPtr = _lookup<ffi.NativeFunction<NativeHelloWorldFunction>>('hello_world');

  late final ffi.Pointer<sem_t> Function(ffi.Pointer<ffi.Char> name, int oflag, int mode, int value) _hello_world =
      _hello_worldPtr.cast<ffi.NativeFunction<NativeHelloWorldFunction>>().asFunction();
}
